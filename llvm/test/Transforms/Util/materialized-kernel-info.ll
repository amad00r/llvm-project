...
; CHECK-DAG: @__omp_offloading_nvptx_l42_kernel_info = constant [8 x i8] c"\00@\00\00\03\00\00\01"
define weak_odr protected ptx_kernel void @__omp_offloading_nvptx_l42(i64 %x, ptr %dyn) "kernel" {
  ret void
}

; CHECK-DAG: @__omp_offloading_amdgpu_l43_kernel_info = constant [8 x i8] c"\00@\00\00\03\00\00\01"
define weak_odr protected amdgpu_kernel void @__omp_offloading_amdgpu_l43(i64 %x, ptr %dyn) "kernel" {
  ret void
}

; CHECK-DAG: @__omp_offloading_amdgpu_l44_kernel_info = constant [8 x i8] c"\00 \00\00\03\00\00\01"
define weak_odr protected amdgpu_kernel void @__omp_offloading_amdgpu_l44(i64 %x, ptr %dyn) "kernel" {
...
; CHECK-DAG: @__omp_offloading_nvptx_l45_kernel_info = constant [16 x i8] c"\02\00\00\01\02\00\00\00\02\00\00\00\03\00\00\01"
define weak_odr protected ptx_kernel void @__omp_offloading_nvptx_l45(ptr noundef nonnull align 8 dereferenceable(8) %0, i64 noundef %1, i64 noundef %2, ptr noalias noundef %3) "kernel" {
